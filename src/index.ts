...
const DatabaseImpl: DatabaseImplConstructor = function (
    this: DatabaseImpl | void,
    file?: string
) {
    ...
    /* Register modules */
    databaseImplThis!.add = (key, value, options?) =>
        arbitrate(database, 'Add', {
            id: key,
            data: value,
            options
        })

    databaseImplThis!.subtract = (key, value, options?) =>
        arbitrate(database, 'Subtract', {
            id: key,
            data: value,
            options
        })

    databaseImplThis!.push = (key, value, options?) =>
        arbitrate(database, 'Push', {
            id: key,
            data: value,
            options
        })

    databaseImplThis!.set = (key, value, options?) =>
        arbitrate(database, 'Set', {
            id: key,
            data: value,
            options
        })

    databaseImplThis!.get = (key, options?) =>
        arbitrate(database, 'Get', {
            id: key,
            options
        })

    databaseImplThis!.has = (key, options?) =>
        arbitrate(database, 'Has', {
            id: key,
            options
        })

    databaseImplThis!.type = (key, options?) =>
        arbitrate(database, 'Type', {
            id: key,
            options
        })

    databaseImplThis!.delete = (key, options?) =>
        arbitrate(database, 'Delete', {
            id: key,
            options
        })

    databaseImplThis!.all = (options?) =>
        arbitrate(database, 'All', {
            options
        })

    databaseImplThis!.clear = (options?) =>
        arbitrate(database, 'Clear', {
            options
        })
    ...
    databaseImplThis.table = function (this: Table | void, tableName: string) {
        ...
        tableThis!.add = (key, value, options?) =>
            arbitrate(
                database,
                'Add',
                {
        ...
        tableThis!.subtract = (key, value, options?) =>
            arbitrate(
                database,
                'Subtract',
                {
        ...
        tableThis!.push = (key, value, options?) =>
            arbitrate(
                database,
                'Push',
                {
        ...
        tableThis!.set = (key, value, options?) =>
            arbitrate(
                database,
                'Set',
                {
